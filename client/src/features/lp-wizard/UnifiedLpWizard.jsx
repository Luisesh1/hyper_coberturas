...
import EthUsdcRangeCard from './steps/EthUsdcRangeCard';
      ...
      >
        ...
        {!flow.isBusy && step === RANGE && flow.suggestions && (
          <div className={styles.stepBody}>
            {isOrchestrated && (
              <EthUsdcRangeCard
                recommendation={unified.ethUsdcRangeRecommendation}
                applied={unified.ethUsdcRangeRecommendationApplied}
                confirmed={unified.ethUsdcRangeConfirmed}
                onConfirmedChange={unified.setEthUsdcRangeConfirmed}
                blocked={unified.rangeConfirmationBlocked}
                onApply={unified.applyEthUsdcRangeRecommendation}
              />
            )}
