...
export const INDICATORS = {
  ...
  rsi: {
    ...
    category: 'momentum',
    pane: 'subpane',
    defaultParams: { length: 14, highLevel: 70, lowLevel: 30 },
    paramSchema: [
      { key: 'length', type: 'number', label: 'Periodo', min: 2, max: 200, step: 1 },
      { key: 'highLevel', type: 'number', label: 'Valor alto RSI', min: 0, max: 100, step: 1 },
      { key: 'lowLevel', type: 'number', label: 'Valor bajo RSI', min: 0, max: 100, step: 1 },
    ],
  ...
  adx: {
    ...
    category: 'trend',
    pane: 'subpane',
    defaultParams: { length: 14, showADX: true, showDIPlus: true, showDIMinus: true },
    paramSchema: [
      { key: 'length', type: 'number', label: 'Periodo', min: 2, max: 100, step: 1 },
      { key: 'showADX', type: 'boolean', label: 'Mostrar ADX' },
      { key: 'showDIPlus', type: 'boolean', label: 'Mostrar +DI' },
      { key: 'showDIMinus', type: 'boolean', label: 'Mostrar -DI' },
    ],
  ...
  sqzmom: {
    ...
    paramSchema: [
      ...
      { key: 'showNormalUpper', type: 'boolean', label: 'Mostrar linea superior' },
      { key: 'showNormalMiddle', type: 'boolean', label: 'Mostrar linea media' },
      { key: 'showNormalLower', type: 'boolean', label: 'Mostrar linea inferior' },
      { key: 'normalBandLength', type: 'number', label: 'Periodo banda', min: 2, max: 500, step: 1 },
      { key: 'normalBandSigma', type: 'number', label: 'Sigma extremo', min: 0.1, max: 5, step: 0.1 },
    ],
    defaultStyle: {},
  },
};
